...
Параметры меняются в ручную в файле input.json.

### Вывод

Если сравнивать сегментацию и бинаризацию из 4 ЛР, то можно понять по метрикам, что сегментация работает лучше. Точность намного выше из-за меньшего процента false recalls, а сегментация не имеет такого широкого диапазона восприятия, запоминания и оценки F1.